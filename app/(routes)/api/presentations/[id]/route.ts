  ...
  try {
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { error: errorData.message || 'Failed to fetch presentation' }, 
...
export async function PUT(
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json();
      return NextResponse.json(
        { error: errorData.message || 'Failed to update presentation' }, 
        { status: response.status }
      );
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json();
      return NextResponse.json(
        { error: errorData.message || 'Failed to delete presentation' }, 
        { status: response.status }
      );
    }
