...
export type NavigationIconName = 'home' | 'folder-kanban' | 'square-kanban' | 'panels-top-left' | 'layout-template' | 'component' | 'type' | 'upload' | 'shapes' | 'database' | 'brain' | 'message-circle' | 'panel-top';
