...
export default function PageNavigation({
    ...
    return (
        <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-3 py-3 px-6 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.09)] bg-white border border-gray-100">
