...
export default function EditorNavbar() {
  ...
  return (
    <div className="flex h-header z-header sticky items-center px-4 shadow bg-gradient-to-r from-brand-blue via-brand-blue/90 to-brand-teal border-b border-[rgba(255,255,255,0.1)]">
      {/* Left Section */}
