        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
          ...
          >
            <div className="py-1.5">
              <button
                className={`w-full text-left px-3 py-2 flex items-center gap-3 transition-colors ${isEditMode ? 'bg-brand-blue-light/10' : 'hover:bg-gray-50'
                  }`}
                onClick={setEditingMode}
                role="menuitem"
                aria-selected={isEditMode}
              >
                <div className={`p-1.5 rounded-full ${isEditMode ? 'bg-brand-blue-light text-brand-blue' : 'bg-gray-100 text-gray-500'
                  } flex-shrink-0`}>
