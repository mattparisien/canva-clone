          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Avatar className="h-9 w-9 cursor-pointer ring-2 ring-white hover:ring-primary transition-all">
                ...
                <AvatarFallback className="bg-gradient-to-r from-[#2ec4e6] to-[#7c3aed] text-white">MP</AvatarFallback>
              </Avatar>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-56 p-2">
              <div className="flex items-center gap-3 p-2">
                ...
                <div>
                  <p className="text-sm font-medium">Matt Parisien</p>
                  <p className="text-xs text-gray-500">matt@example.com</p>
                </div>
              </div>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer rounded-md">Profile</DropdownMenuItem>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer rounded-md">Log out</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </div>
